...
import numpy as np
import pandas as pd
from experiments.utils import get_result_dir
from mobo.utils import calc_hypervolume, find_pareto_front
...
class DataExport:
    def __init__(self, optimizer, X, Y, args):
        ...
        self.has_family = (
            hasattr(self.optimizer.selection, "has_family") and self.optimizer.selection.has_family
        )
